...
function Update()
	...
	for i=1,#tasks,1 do 
		...
		dynamicOutput[#dynamicOutput + 1] = "DynamicVariables=1"
			...
			--add line
		dynamicOutput[#dynamicOutput + 1] = "[MeasureInputLine]"
		dynamicOutput[#dynamicOutput + 1] = "Meter=Image"
		dynamicOutput[#dynamicOutput + 1] = "SolidColor=255,255,255,255"
		dynamicOutput[#dynamicOutput + 1] = "X=10"
		dynamicOutput[#dynamicOutput + 1] = "Y=34"
		dynamicOutput[#dynamicOutput + 1] = "H=3"
		dynamicOutput[#dynamicOutput + 1] = "W=("..SKIN_WIDTH.." - 10)"
		dynamicOutput[#dynamicOutput + 1] = "[MeasureInputBack]"
		dynamicOutput[#dynamicOutput + 1] = "Meter=Image"
		dynamicOutput[#dynamicOutput + 1] = "X=10"
		dynamicOutput[#dynamicOutput + 1] = "Y=10"
		dynamicOutput[#dynamicOutput + 1] = "H=24"
		dynamicOutput[#dynamicOutput + 1] = "SolidColor=1,1,1,1"
		dynamicOutput[#dynamicOutput + 1] = "W=("..SKIN_WIDTH.." - 10)"
		dynamicOutput[#dynamicOutput + 1] = 'LeftMouseUpAction=[!CommandMeasure MeasureInput "ExecuteBatch 1-2"]'
		dynamicOutput[#dynamicOutput + 1] = "[MeasureInput]"
		dynamicOutput[#dynamicOutput + 1] = "Measure=Plugin"
		dynamicOutput[#dynamicOutput + 1] = "Plugin=InputText"
		dynamicOutput[#dynamicOutput + 1] = "SolidColor=30,30,30,255"
		dynamicOutput[#dynamicOutput + 1] = "FontColor=255,255,255,255"
		dynamicOutput[#dynamicOutput + 1] = "FontFace=Consolas"
		dynamicOutput[#dynamicOutput + 1] = "FontSize=16"
		dynamicOutput[#dynamicOutput + 1] = "X=R"
		dynamicOutput[#dynamicOutput + 1] = "Y=10"
		dynamicOutput[#dynamicOutput + 1] = "H=24"
		dynamicOutput[#dynamicOutput + 1] = "W=("..SKIN_WIDTH.." - 10)"
		dynamicOutput[#dynamicOutput + 1] = "DefaultValue="
		dynamicOutput[#dynamicOutput + 1] = 'Command1=["$UserInput$"] X=10 Y=10 DefaultValue='
		dynamicOutput[#dynamicOutput + 1] = 'Command2=[!CommandMeasure "MeasureDynamicTasks" "AddTask(\'[MeasureInput]\')"][!Refresh][!Refresh]'
		...
		dynamicOutput[#dynamicOutput + 1] = "X=8r+R"
		dynamicOutput[#dynamicOutput + 1] = "Y=10"
	...
	if #tasks == 1 then
		dynamicOutput[#dynamicOutput + 1] = "[MeterNotification]"
		dynamicOutput[#dynamicOutput + 1] = "DynamicVariables=1"
		dynamicOutput[#dynamicOutput + 1] = "Meter=String"
		dynamicOutput[#dynamicOutput + 1] = "Text=What for today?"
		dynamicOutput[#dynamicOutput + 1] = "FontSize="..FONT_SIZE..""
		dynamicOutput[#dynamicOutput + 1] = "FontColor="..BUTTON_COLOR..""
		dynamicOutput[#dynamicOutput + 1] = "SolidColor=255,255,255,0"
		dynamicOutput[#dynamicOutput + 1] = "AntiAlias=1"
		dynamicOutput[#dynamicOutput + 1] = "ClipString=1"
		dynamicOutput[#dynamicOutput + 1] = "X=10"
		dynamicOutput[#dynamicOutput + 1] = "Y=8"
		...
		dynamicOutput[#dynamicOutput + 1] = "DynamicVariables=1"
		dynamicOutput[#dynamicOutput + 1] = "Meter=String"
		dynamicOutput[#dynamicOutput + 1] = "Text=todo list"
		dynamicOutput[#dynamicOutput + 1] = "FontSize="..FONT_SIZE..""
		dynamicOutput[#dynamicOutput + 1] = "FontColor="..BUTTON_COLOR..""
		dynamicOutput[#dynamicOutput + 1] = "SolidColor=255,255,255,0"
		dynamicOutput[#dynamicOutput + 1] = "AntiAlias=1"
	...
	for i=1,#tasks,1 do
		if i == 1 then
			...
			dynamicOutput[#dynamicOutput + 1] = "H=35"
			dynamicOutput[#dynamicOutput + 1] = "W=200"
		...
		if tasks[i][COLUMN_INDEX_CHECKBOX] == isSelectedMark then
			dynamicOutput[#dynamicOutput + 1] = "FontColor="..COMLETED_TASK_COLOR..""
			-- dynamicOutput[#dynamicOutput + 1] = "StringStyle=line-through"
